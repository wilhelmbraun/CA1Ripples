...
#Script is setup so that its execution will generate data for Fig. 8. It can easily be adapted (lines 800- 884) to generate the data for all parameter plots in the manuscript.
#Code for model 1 starts on line 49, for model 2 on line 278 and code for model 3 on line 508.
#############
#############
